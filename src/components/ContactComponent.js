                ...
                <div className="row row-content">
                    ...
                    <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                        <Row className="form-group">
                           ...
                           <Col md={10}>
                               <Control.text model=".firstName" id="firstName" name="firstName" placeholder="First Name" className="form-control" />              </Col>
                        </Row>
                        <Row className="form-group">
                        ...
                        <Row className="form-group">
                           ...
                           <Col md={10}>
                               <Control.text model=".email" className="form-control" id="email" name="email" placeholder="email" />                    </Col>
                        </Row>
                        <Row className="form-group">
